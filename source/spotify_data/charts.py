...
def make_song_rank_changes_comparison_chart(
...
def make_artist_popularity_map(
...
def make_top_streamed_artist_comparison_chart(
    artist_streams,
    artists_name,
    region_name,
    artist_streams_2,
